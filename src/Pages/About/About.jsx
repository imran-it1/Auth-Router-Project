const About = () => {
	return (
		<div className=" container mx-auto pt-5  h-screen justify-center items-center">
			<a href="#" className=" h-full group relative block">
				<div className="relative h-[90vh]">
					<img
						src="https://images.unsplash.com/photo-1593795899768-947c4929449d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2672&q=80"
						alt=""
						className="h-full absolute inset-0 w-full object-cover opacity-100 group-hover:opacity-0"
					/>
					<img
				...
				<div className="h-[90vh] absolute inset-0 flex flex-col items-start justify-end p-6">
